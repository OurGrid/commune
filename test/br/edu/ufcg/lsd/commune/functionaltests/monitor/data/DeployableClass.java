...
public class DeployableClass implements DeployableInterface {
	...
	public void invoke(
			@MonitoredBy(OBJECT_NAME)Stub stub1) {

	}
	
	public void invoke2(
			@MonitoredBy(OBJECT_NAME)Stub stub1, @MonitoredBy(OBJECT_NAME)Stub2 stub2) {
