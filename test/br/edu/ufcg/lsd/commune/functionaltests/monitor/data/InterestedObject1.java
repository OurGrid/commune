...
public class InterestedObject1 implements InterestInterface1 {
	...
	public static final String PUBLIC_KEY = "publicKeyX";


	
	@InvokeOnDeploy
	public void init(ServiceManager manager) {
		manager.registerInterest(OTHER_SERVICE_NAME, USER + "@" + SERVER + "/" + CONTAINER + "/" + SERVICE, Stub.class);
	}
	
	@RecoveryNotification
	public void toDO(Stub stub) {
		
	}

	@FailureNotification
	public void toDone(Stub stub) {
