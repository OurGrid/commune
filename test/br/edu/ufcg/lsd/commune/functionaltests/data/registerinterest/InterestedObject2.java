...
public class InterestedObject2 implements InterestInterface1 {
	...
	public void init(ServiceManager manager) {
		manager.registerInterest(OTHER_SERVICE_NAME, USER + "@" + SERVER + "/" + CONTAINER + "/" + SERVICE, Stub1.class);
	}
	
	@RecoveryNotification
	public void toDO(Stub1 stub1) {
