...
public class ConnectionProtocolBlockingTest {
	...
	@Test
	public void applicationSecondMessageLostConnectionRecovery() throws Exception {
		MessageBlocker blocker = 
			createBlocker(a_module, DO_NOT_BLOCK_FUNCTION, DO_NOT_BLOCK_SEQUENCE, A_APPLICATION_MESSAGE, 2L);
