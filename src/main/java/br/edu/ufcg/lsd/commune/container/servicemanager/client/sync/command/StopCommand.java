 ...
 *
 */
public class StopCommand extends AbstractCommand<SyncApplicationClient<?,?>> {

	public StopCommand(SyncApplicationClient<?, ?> componentClient) {
	...
	protected void execute(String[] params) throws Exception {
		if (isComponentStarted()) {
			getComponentClient().stop(true, true);
		} else {
			printError();
		}
	}
	...
	private void printError() {
		System.out.println("Component is not started.");
	}
}
