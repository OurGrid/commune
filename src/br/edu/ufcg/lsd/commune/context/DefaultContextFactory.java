...
public class DefaultContextFactory implements ContextFactory {
	...
	public Map<Object, Object> getDefaultProperties() {
		...
		properties.put( InterestProperties.PROP_WAN_HEARTBEAT_DELAY, "15" );
		properties.put( InterestProperties.PROP_WAN_DETECTION_TIME, "120" );
		properties.put( InterestProperties.PROP_LAN_HEARTBEAT_DELAY, "3" );
		properties.put( InterestProperties.PROP_LAN_DETECTION_TIME, "30" );
		properties.put( InterestProperties.PROP_LOCAL_HEARTBEAT_DELAY, "1" );
		properties.put( InterestProperties.PROP_LOCAL_DETECTION_TIME, "10" );
